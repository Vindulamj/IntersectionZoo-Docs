...
V. Jayawardana, B. Freydt, A. Qu, C. Hickert, Z. Yan, C. Wu, `IntersectionZoo: Eco-driving for Benchmarking Multi-Agent Contextual Reinforcement Learning <https://arxiv.org/abs/2410.15221>`_, International Conference on Learning Representations (ICLR) 2025.
